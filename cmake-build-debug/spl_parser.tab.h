...
/**
 ** \file C:/Users/DELL/Desktop/course/compiler/SPLCompiler/cmake-build-debug/spl_parser.tab.h
...
#ifndef YY_YY_C_USERS_DELL_DESKTOP_COURSE_COMPILER_SPLCOMPILER_CMAKE_BUILD_DEBUG_SPL_PARSER_TAB_H_INCLUDED
# define YY_YY_C_USERS_DELL_DESKTOP_COURSE_COMPILER_SPLCOMPILER_CMAKE_BUILD_DEBUG_SPL_PARSER_TAB_H_INCLUDED
// //                    "%code requires" blocks.
#line 28 "spl_parser.y" // lalr1.cc:401
...
#line 65 "C:/Users/DELL/Desktop/course/compiler/SPLCompiler/cmake-build-debug/spl_parser.tab.h" // lalr1.cc:401
...
#line 25 "spl_parser.y" // lalr1.cc:401
namespace SPL {
#line 181 "C:/Users/DELL/Desktop/course/compiler/SPLCompiler/cmake-build-debug/spl_parser.tab.h" // lalr1.cc:401
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == 0 || tok == token::ASSIGN || tok == token::PLUS || tok == token::MINUS || tok == token::MUL || tok == token::DIV || tok == token::MOD || tok == token::NOT || tok == token::AND || tok == token::ARRAY || tok == token::BEGIN || tok == token::CASE || tok == token::CONST || tok == token::DO || tok == token::DOWNTO || tok == token::ELSE || tok == token::END || tok == token::FOR || tok == token::FUNCTION || tok == token::GOTO || tok == token::IF || tok == token::IN || tok == token::OF || tok == token::OR || tok == token::PACKED || tok == token::PROCEDURE || tok == token::PROGRAM || tok == token::RECORD || tok == token::REPEAT || tok == token::SET || tok == token::THEN || tok == token::TO || tok == token::TYPE || tok == token::UNTIL || tok == token::VAR || tok == token::WHILE || tok == token::WITH || tok == token::READ || tok == token::GE || tok == token::GT || tok == token::LE || tok == token::LT || tok == token::EQUAL || tok == token::UNEQUAL || tok == token::LP || tok == token::RP || tok == token::LB || tok == token::RB || tok == token::COMMA || tok == token::COLON || tok == token::DOTDOT || tok == token::DOT || tok == token::SEMI);
      }
#else
      ...
      symbol_type (int tok, int v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::SYS_CON || tok == token::SYS_FUNCT || tok == token::SYS_PROC || tok == token::SYS_TYPE || tok == token::INTEGER);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::STRING || tok == token::NAME || tok == token::ID);
      }
#else
...
#line 2090 "C:/Users/DELL/Desktop/course/compiler/SPLCompiler/cmake-build-debug/spl_parser.tab.h" // lalr1.cc:401




#endif // !YY_YY_C_USERS_DELL_DESKTOP_COURSE_COMPILER_SPLCOMPILER_CMAKE_BUILD_DEBUG_SPL_PARSER_TAB_H_INCLUDED
